...
thumbnail: "https://m.media-amazon.com/images/I/61rDctkPw6L.jpg",
  ...
  },
  {
    ...
    brand: "Artistic Haven",
    description: "Vivid and expressive abstract canvas for your walls.",
    specifications: {
      type: "Canvas Art",
      material: "Canvas",
      color: "Multicolor",
      features: "Hand-painted, Ready to Hang",
    },
    price: 89.99,
    offerPrice: 74.99,
    stock: 50,
    ...
    reviews: [
      {
        user: "ArtLover87",
        rating: 5,
        comment: "Absolutely love the colors and texture!",
      },
      {
        user: "DesignEnthusiast123",
        rating: 4,
        comment: "Looks stunning on my living room wall.",
      },
    ],
    saleAvailable: false,
    featured: true,
  ...
  },
  {
    ...
    description: "Bringing the serenity of nature to your walls.",
    specifications: {
      type: "Printed Art",
      material: "Paper",
      color: "Green, Brown",
      features: "High-quality print, Framed",
    },
    price: 64.99,
    offerPrice: 54.99,
    stock: 30,
    ...
    reviews: [
      {
        user: "NatureLover55",
        rating: 5,
        comment: "Brings a calming vibe to the room!",
      },
      {
        user: "HikerGirl23",
        rating: 4,
        comment: "Reminds me of peaceful hikes in the woods.",
      },
    ],
    saleAvailable: true,
    featured: false,
  },
  {
    ...
    subcategory: "Decoration",
    subSubcategory: "Wall Art",
    name: "Modern Geometric Wall Sculpture",
    brand: "Geometric Designs Co.",
    description: "Sleek and contemporary wall sculpture.",
    specifications: {
      type: "Metal Art",
      material: "Metal",
      color: "Black",
      features: "Geometric shapes, 3D design",
    },
    price: 119.99,
    offerPrice: 99.99,
    stock: 20,
    ...
    reviews: [
      {
        user: "ModernArtFanatic",
        rating: 5,
        comment: "Absolutely stunning piece of art!",
      },
      {
        user: "InteriorDesigner007",
        rating: 5,
        comment: "Adds an avant-garde touch to any space.",
      },
    ],
    saleAvailable: true,
    featured: true,
  },
  {
    ...
    subcategory: "Decoration",
    subSubcategory: "Wall Art",
    name: "Vintage Botanical Prints Set",
    brand: "Botanical Prints & Co.",
    description: "Classic botanical illustrations perfect for framing.",
    specifications: {
      type: "Print Set",
      material: "Paper",
      color: "Sepia",
      features: "Set of 4 prints, Vintage style",
    },
    price: 49.99,
    offerPrice: 44.99,
    stock: 60,
    ...
    reviews: [
      {
        user: "VintageArtFan",
        rating: 5,
        comment: "Beautiful vintage prints, love the details!",
      },
      {
        user: "CollectorDiana",
        rating: 4,
        comment: "Great addition to my antique-themed room.",
      },
    ],
    saleAvailable: true,
    featured: false,
  },
  {
    ...
    category: "Home & Living",
    subcategory: "Decoration",
    subSubcategory: "Candles & Holders",
    name: "Aromatic Scented Candles Set",
    brand: "Fragrance Haven",
    description: "Set of scented candles in elegant holders.",
    specifications: {
      type: "Scented Candles",
      material: "Soy Wax",
      color: "Assorted",
      features: "Variety of fragrances, Decorative holders",
    },
    price: 34.99,
    offerPrice: 29.99,
    stock: 40,
    thumbnail: "https://example.com/candles-thumbnail.jpg",
    images: [
      "https://example.com/candles-image1.jpg",
      "https://example.com/candles-image2.jpg",
    ],
    ratings: {
      average: 4.6,
      total: 55,
    ...
    reviews: [
      {
        user: "AromaLover22",
        rating: 5,
        comment: "Lovely scents, perfect for relaxation!",
      },
      {
        user: "DecorEnthusiast78",
        rating: 4,
        comment: "Adds a cozy ambiance to any room.",
      },
    ],
    saleAvailable: true,
    featured: true,
  ...
  subcategory: "Decoration",
  subSubcategory: "Candles & Holders",
  name: "Glass Tea Light Holders Set",
  brand: "Luminous Accents",
  description: "Set of elegant glass tea light holders.",
  specifications: {
    type: "Tea Light Holders",
    material: "Glass",
    color: "Clear",
    features: "Sleek design, Fits standard tea lights",
  },
  price: 24.99,
  offerPrice: 19.99,
  stock: 60,
  thumbnail: "https://example.com/tea-light-holders-thumbnail.jpg",
  images: [
    "https://example.com/tea-light-holders-image1.jpg",
    "https://example.com/tea-light-holders-image2.jpg",
  ],
  ratings: {
    average: 4.9,
    total: 40,
  ...
  reviews: [
    {
      user: "DecorEnthusiast99",
      rating: 5,
      comment: "Love the elegant simplicity of these holders!",
    },
    {
      user: "HomeDecorator123",
      rating: 4,
      comment: "Adds a touch of sophistication to my decor.",
    },
  ],
  saleAvailable: true,
  featured: false,
},
{
  ...
  subcategory: "Decoration",
  subSubcategory: "Candles & Holders",
  name: "Rustic Wooden Candle Holders Set",
  brand: "Country Crafts",
  description: "Set of wooden candle holders with a rustic charm.",
  specifications: {
    type: "Candle Holders",
    material: "Wood",
    color: "Natural Wood Finish",
    features: "Assorted sizes, Suitable for various candle types",
  },
  price: 39.99,
  offerPrice: 34.99,
  stock: 25,
  thumbnail: "https://example.com/wooden-candle-holders-thumbnail.jpg",
  images: [
    "https://example.com/wooden-candle-holders-image1.jpg",
    "https://example.com/wooden-candle-holders-image2.jpg",
  ],
  ratings: {
    average: 4.7,
    total: 30,
  ...
  reviews: [
    {
      user: "RusticChicDecor22",
      rating: 5,
      comment: "Adds a cozy touch to my farmhouse decor!",
    },
    {
      user: "NatureLover89",
      rating: 4,
      comment: "Love the natural look of these holders.",
    },
  ],
  saleAvailable: true,
  featured: true,
},
{
  ...
  subcategory: "Decoration",
  subSubcategory: "Candles & Holders",
  name: "Metallic Geometric Candle Lantern",
  brand: "Modern Elegance",
  description: "Stylish geometric candle lantern for contemporary spaces.",
  specifications: {
    type: "Candle Lantern",
    material: "Metal",
    color: "Gold",
    features: "Geometric design, Suitable for pillar candles",
  },
  price: 49.99,
  offerPrice: 44.99,
  stock: 20,
  thumbnail: "https://example.com/candle-lantern-thumbnail.jpg",
  images: [
    "https://example.com/candle-lantern-image1.jpg",
    "https://example.com/candle-lantern-image2.jpg",
  ],
  ratings: {
    average: 4.6,
    total: 25,
  ...
  reviews: [
    {
      user: "ModernDecorFanatic",
      rating: 5,
      comment: "Absolutely stunning piece, love the design!",
    },
    {
      user: "InteriorStylist007",
      rating: 4,
      comment: "Adds a touch of glamour to any setting.",
    },
  ],
  saleAvailable: true,
  featured: false,
},
{
  ...
  subcategory: "Decoration",
  subSubcategory: "Candles & Holders",
  name: "Crystal Votive Candle Holders Set",
  brand: "Elegant Crystals",
  description: "Set of crystal votive candle holders for elegance.",
  specifications: {
    type: "Votive Candle Holders",
    material: "Crystal",
    color: "Clear",
    features: "Sparkling crystals, Fits standard votive candles",
  },
  price: 59.99,
  offerPrice: 49.99,
  stock: 15,
  thumbnail: "https://example.com/crystal-candle-holders-thumbnail.jpg",
  images: [
    "https://example.com/crystal-candle-holders-image1.jpg",
    "https://example.com/crystal-candle-holders-image2.jpg",
  ],
  ratings: {
    average: 4.9,
    total: 18,
  ...
  reviews: [
    {
      user: "LuxuryLifestyleFan",
      rating: 5,
      comment: "Exquisite crystal holders, perfect for special occasions!",
    },
    {
      user: "DecorEnthusiast2023",
      rating: 5,
      comment: "Elevates the ambiance with a touch of sophistication.",
    },
  ],
  saleAvailable: true,
  featured: true,
},
{
  ...
  subSubcategory: "Sofas",
  name: "Modern Leather Sofa",
  brand: "Urban Comforts",
  description: "Luxurious and comfortable leather sofa for modern living spaces.",
  specifications: {
    type: "Sofa",
    material: "Leather",
    color: "Black",
    features: "Sleek design, Comfortable cushions",
  },
  price: 899.99,
  offerPrice: 799.99,
  stock: 10,
  thumbnail: "https://example.com/sofa-thumbnail.jpg",
  images: [
    "https://example.com/sofa-image1.jpg",
    "https://example.com/sofa-image2.jpg",
  ],
  ratings: {
    average: 4.9,
    total: 15,
  ...
  reviews: [
    {
      user: "ModernHomeowner",
      rating: 5,
      comment: "Love the stylish design and comfort!",
    },
    {
      user: "InteriorDesignPro",
      rating: 5,
      comment: "Great addition to any contemporary space.",
    },
  ],
  saleAvailable: false,
  featured: true,
},
{
  ...
  brand: "Classic Comforts",
  description: "Iconic and comfortable lounge chair for relaxation.",
  specifications: {
    type: "Lounge Chair",
    material: "Wood and Leather",
    color: "Walnut Brown",
    features: "Elegant design, Ergonomic support",
  },
  price: 499.99,
  offerPrice: 449.99,
  stock: 20,
  thumbnail: "https://example.com/chair-thumbnail.jpg",
  images: [
    "https://example.com/chair-image1.jpg",
    "https://example.com/chair-image2.jpg",
  ],
  ratings: {
    average: 4.7,
    total: 25,
  ...
  reviews: [
    {
      user: "ComfortSeeker25",
      rating: 5,
      comment: "Superb comfort and timeless design!",
    },
    {
      user: "DesignEnthusiast567",
      rating: 4,
      comment: "A classic addition to my reading nook.",
    },
  ],
  saleAvailable: true,
  featured: false,
},
{
  ...
  brand: "Vintage Vibes",
  description: "Sturdy and stylish coffee table with an industrial touch.",
  specifications: {
    type: "Coffee Table",
    material: "Wood and Metal",
    color: "Rustic Brown",
    features: "Vintage design, Durable construction",
  },
  price: 349.99,
  offerPrice: 299.99,
  stock: 15,
  thumbnail: "https://example.com/table-thumbnail.jpg",
  images: [
    "https://example.com/table-image1.jpg",
    "https://example.com/table-image2.jpg",
  ],
  ratings: {
    average: 4.8,
    total: 18,
  ...
  reviews: [
    {
      user: "VintageFanatic",
      rating: 5,
      comment: "Absolutely love the industrial look of this table!",
    },
    {
      user: "HomeDecorEnthusiast",
      rating: 4,
      comment: "Fits perfectly in my eclectic living room.",
    },
  ],
  saleAvailable: true,
  featured: true,
